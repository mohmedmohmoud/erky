...
class Shipment(models.Model):
    ...
    shipment_date = fields.Date("Shipment Date", default=datetime.today())
    ...
    origin_shipped_uom_id = fields.Many2one("product.uom", readonly=1)
    base_shipped_uom_id = fields.Many2one("product.uom", readonly=1)
...
class ShipmentContainer(models.Model):
    ...
    gross_weight = fields.Float("Gross Weight", compute="_compute_shipment_qty", store=True)
    shipment_uom_id = fields.Many2one("product.uom", "Shipment UOM", required=0)
